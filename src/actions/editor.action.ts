...
export async function generateEditorContent({
    ...
    try {
        ...
        const wordCountInstruction = maxLength
            ? `Response should be approximately ${Math.min(maxLength, 500)} words or less`
            : "Response should be 100 to 200 words long";
